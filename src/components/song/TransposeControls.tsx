...
export default function TransposeControls({
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 p-3 bg-slate-800/50 border border-slate-700 rounded-lg">
      ...
      <div className={`flex items-center gap-1 ${momentMode ? 'opacity-0 pointer-events-none' : ''}`}>
      ...
      <div className={`flex items-center gap-1 ml-auto ${momentMode ? 'opacity-0 pointer-events-none' : ''}`}>
        {/* Comment toggle */}
        <button
